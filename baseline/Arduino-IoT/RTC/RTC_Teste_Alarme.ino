...
// o Pino SQW deve ser ligado ao pino 19 no Mega. Isso varia de placa para placa
#define sqw_pin 2 // Mega. No UNO, mude para 19
#define int_number 0 // Mega. No UNO, mude para 4
